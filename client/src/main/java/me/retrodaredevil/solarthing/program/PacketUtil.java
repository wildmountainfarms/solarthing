...
public class PacketUtil {
	...
	public static @Nullable List<FragmentedPacketGroup> getPacketGroups(@Nullable String sourceId, DefaultInstanceOptions defaultInstanceOptions, List<? extends PacketGroup> packetGroups){
