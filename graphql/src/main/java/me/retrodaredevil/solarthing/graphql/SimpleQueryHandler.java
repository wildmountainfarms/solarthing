...
public class SimpleQueryHandler {
	...
	public SimpleQueryHandler(DefaultInstanceOptions defaultInstanceOptions, CouchDbDatabaseSettings couchDbDatabaseSettings) {
		...
		database = CouchDbSolarThingDatabase.create(instance);
		// TODO we may want to pass our own object mapper to the SolarThingDatabase instance. We were doing this before the refactor on 2021.05.10
	}
