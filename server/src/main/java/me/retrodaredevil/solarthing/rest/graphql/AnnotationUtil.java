...
public final class AnnotationUtil {
	...
	public static <T extends Annotation> @Nullable T getAnnotation(Class<T> annotationClass, Method method, Class<?> declaringClass) {
	...
	public static <T extends Annotation> @Nullable T getAnnotation(Class<T> annotationClass, Method method) {
	...
	public static <T extends Annotation> @Nullable T getAnnotation(Class<T> annotationClass, Member member) {
	...
	public static <T extends Annotation> @Nullable T getAnnotation(Class<T> annotationClass, AnnotatedMember annotatedMember) {
		return getAnnotation(annotationClass, annotatedMember.getMember());
	}
	public static <T extends Annotation> @Nullable T getAnnotation(Class<T> annotationClass, TypedElement typedElement) {
