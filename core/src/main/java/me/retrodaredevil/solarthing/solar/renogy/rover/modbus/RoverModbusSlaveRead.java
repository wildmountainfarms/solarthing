...
public class RoverModbusSlaveRead implements RoverReadTable {
	...
	private static final MessageHandler<int[]> MAX_VOLTAGE_AND_CHARGING = new ReadRegistersHandler(0x000A, 1);
	@Override
	...
	private static final MessageHandler<int[]> DISCHARGING_AND_PRODUCT_TYPE = new ReadRegistersHandler(0x000B, 1);
	...
	private static final MessageHandler<int[]> HARDWARE_VERSION = new ReadRegistersHandler(0x0016, 2);
	@Override public int getHardwareVersionValue() {
		return twoRegistersAsInt(HARDWARE_VERSION);
	}
	private static final MessageHandler<int[]> PRODUCT_SERIAL = new ReadRegistersHandler(0x0018, 2);
	...
	private static final MessageHandler<int[]> DAILY_MAX_BATTERY_VOLTAGE = new ReadRegistersHandler(0x010C, 1);
	...
	private static final MessageHandler<int[]> DAILY_MAX_DISCHARGING_CURRENT = new ReadRegistersHandler(0x010E, 1);
	@Override
	public float getDailyMaxDischargingCurrent() {
		return oneRegister(DAILY_MAX_DISCHARGING_CURRENT) / 100.0F;
	}
	private static final MessageHandler<int[]> DAILY_MAX_CHARGING_POWER = new ReadRegistersHandler(0x010F, 1);
	@Override public int getDailyMaxChargingPower() {
		return oneRegister(DAILY_MAX_CHARGING_POWER);
	}
	private static final MessageHandler<int[]> DAILY_MAX_DISCHARGING_POWER = new ReadRegistersHandler(0x0110, 1);
	...
	private static final MessageHandler<int[]> DAILY_AH_DISCHARGING = new ReadRegistersHandler(0x0112, 1);
	...
	private static final MessageHandler<int[]> OVER_DISCHARGE_COUNT = new ReadRegistersHandler(0x0116, 1);
	@Override public int getBatteryOverDischargesCount() {
		return oneRegister(OVER_DISCHARGE_COUNT);
	}
	private static final MessageHandler<int[]> FULL_CHARGE_COUNT = new ReadRegistersHandler(0x0117, 1);
	...
	private static final MessageHandler<int[]> AH_DISCHARGING_COUNT = new ReadRegistersHandler(0x011A, 2);
	...
	private static final MessageHandler<int[]> CUMULATIVE_KWH_DISCHARGING = new ReadRegistersHandler(0x011E, 2);
	...
	private static final MessageHandler<int[]> LED_LOAD_CURRENT = new ReadRegistersHandler(0xE02C, 1);
	@Override public int getLEDLoadCurrentRaw() {
		return oneRegister(LED_LOAD_CURRENT);
	}
	private static final MessageHandler<int[]> SPECIAL_POWER_CONTROL_E02D = new ReadRegistersHandler(0xE02D, 1);
